                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="instructor"><g:message code="quiz.instructor.label" default="Instructor" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: quizInstance, field: 'instructor', 'errors')}">
                                    <g:select name="instructor.id" from="${eel.User.list()}" optionKey="id" value="${quizInstance?.instructor?.id}"  />
                                </td>
                            </tr>
                            --%>
