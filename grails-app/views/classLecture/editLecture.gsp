	...
	<g:ifAllGranted role="ROLE_ADMIN">
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="classLectureId" value="${params.id}" />
                ...
                <div class="buttons">
                    <span class="button"><g:actionSubmit class="save" action="updateLecture" value="${message(code: 'default.button.update.label', default: 'Update')}" /></span>
