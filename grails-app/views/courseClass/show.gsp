            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="courseClass.schoolYear.label" default="School Year" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: courseClassInstance, field: "schoolYear")}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: courseClassInstance, field: "term")}</td>
